...
TOKEN = '8079227105:AAFBWvwUqFCBWU7FCbwIvIL5yM_JJDzBkiU'
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in active_chats:
        ...
        await update.message.reply_text(
            "👋 *Welcome to Binus Chat Bot!*\n\n"
            "Di sini kamu bisa ngobrol secara random dan anonim dengan sesama mahasiswa Binus. "
